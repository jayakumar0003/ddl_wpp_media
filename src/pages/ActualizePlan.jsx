...
import { Upload, FileText, CheckCircle, Menu, ChevronRight, Download } from "lucide-react";
  ...
  const handleOriginalFileChange = (e) => {
    ...
    if (file) {
      if (validateFile(file)) {
        ...
        setOriginalError('Invalid file type. Please select an Excel (.xlsx, .xls) or CSV file.');
      }
    }
  };
  ...
  const handleModifiedFileChange = (e) => {
    ...
    if (file) {
      if (validateFile(file)) {
        ...
        setModifiedError('Invalid file type. Please select an Excel (.xlsx, .xls) or CSV file.');
      }
    }
  };
    ...
    setProcessStatus(
      <div className="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded-lg">
        <div className="flex items-center gap-2">
          ...
          <span className="block sm:inline">Comparing files and recalculating metrics.</span>
        </div>
      </div>
    );
      ...
      setProcessStatus(
        <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg">
          <div className="flex items-center gap-2">
            ...
            <span className="block sm:inline">Your actualized results have been downloaded.</span>
          </div>
        </div>
      );
    }, 2000);
        ...
        >
          ...
          >
            ...
            <div className="p-2 md:p-3">
              ...
              <p className="text-2xl text-dark-blue mb-6">
                Upload your files to accurately recalculate metrics based on actuals.
              </p>
                  ...
                  <div className="border border-dark-blue/20 rounded-xl overflow-hidden bg-white/80 backdrop-blur-sm">
                    ...
                    <div className="p-6">
                      <p className="text-dark-blue/60 mb-4">
                        Upload the original ranker output file (baseline for comparison)
                      </p>
                      ...
                      >
                        <Upload className={`mx-auto mb-4 ${
                          step1Completed ? 'text-green-500' : 'text-dark-blue/40'
                        }`} size={48} />
                ...
                {step1Completed && (
                  ...
                  >
                    <div className="border border-dark-blue/20 rounded-xl overflow-hidden bg-white/80 backdrop-blur-sm">
                      ...
                      <div className="p-6">
                        <p className="text-dark-blue/60 mb-4">
                          Upload the file with your changes to Age-Gender Imps and Number of spots
                        </p>
                        ...
                        >
                          <Upload className={`mx-auto mb-4 ${
                            step2Completed ? 'text-green-500' : 'text-dark-blue/40'
                          }`} size={48} />
                          ...
                          {modifiedFileName && (
                            <div className="mt-4 p-3 bg-green-100 text-green-700 rounded-lg flex items-center justify-center gap-2">
                              <CheckCircle size={18} />
                              <span className="font-medium">{modifiedFileName}</span>
                            </div>
                          )}
                ...
                {step1Completed && step2Completed && (
                  ...
                  >
                      ...
                      <motion.button
                        ...
                        className="px-8 py-3 bg-lemon text-dark-blue rounded-full text-lg font-bold shadow-lg hover:shadow-xl transition-all border-2 border-dark-blue/20 inline-flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {isProcessing ? (
                          <>
