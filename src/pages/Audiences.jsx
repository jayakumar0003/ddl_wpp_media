...
import { fetchAudiences } from "../api/audiencesApi";
  ...
  useEffect(() => {
    const loadAudiences = async () => {
      ...
      try {
        ...
        // Map backend API data to match the UI state structure expected by table and modal
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-gray-200/75">
                    ...
                    <div className="divide-y divide-gray-200/75">
                      <div className="flex flex-col sm:flex-row px-4 py-3 sm:py-3.5 hover:bg-gray-50/50 transition-colors group">
                        ...
                        <span className="w-full sm:w-2/3 text-sm text-gray-900 font-medium break-all">{selectedAudience.id}</span>
                      </div>
                      <div className="flex flex-col sm:flex-row px-4 py-3 sm:py-3.5 hover:bg-gray-50/50 transition-colors group">
                      ...
                      <div className="flex flex-col sm:flex-row px-4 py-3 sm:py-3.5 hover:bg-gray-50/50 transition-colors group">
                        <span className="w-full sm:w-1/3 text-[11px] font-semibold text-gray-400 uppercase tracking-widest mb-1 sm:mb-0 group-hover:text-gray-500 transition-colors">Description</span>
                    ...
                    <div className="divide-y divide-gray-200/75">
                      ...
                      <div className="flex flex-col sm:flex-row px-4 py-3 sm:py-3.5 hover:bg-gray-50/50 transition-colors group">
                        <span className="w-full sm:w-1/3 text-[11px] font-semibold text-gray-400 uppercase tracking-widest mb-1 sm:mb-0 sm:pl-2 group-hover:text-gray-500 transition-colors">Created At</span>
                      ...
                      <div className="flex flex-col sm:flex-row px-4 py-3 sm:py-3.5 hover:bg-blue-50/50 transition-colors group bg-blue-50/30">
                        <span className="w-full sm:w-1/3 text-[11px] font-semibold text-gray-400 uppercase tracking-widest mb-1 sm:mb-0 sm:pl-2">Universe Estimate</span>
                      ...
                      <div className="flex flex-col sm:flex-row px-4 py-3 sm:py-3.5 hover:bg-purple-50/50 transition-colors group bg-purple-50/30">
                        <span className="w-full sm:w-1/3 text-[11px] font-semibold text-gray-400 uppercase tracking-widest mb-1 sm:mb-0 sm:pl-2">VideoAmp Household</span>
                        <span className="w-full sm:w-2/3 text-sm text-gray-900 font-medium sm:pl-2">
