...
import { Calculator, ChevronDown, Menu, ChevronUp } from "lucide-react"; // added ChevronUp
...
const CreatePlan = () => {
  ...
  const [datasetsOpen, setDatasetsOpen] = useState(false); // new state
  ...
  // Budget calculations (same as before)
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      {/* Fixed Header */}
      <header className="fixed top-0 left-0 w-full flex items-center justify-between px-6 py-4 border-b border-dark-blue/10 bg-white/50 backdrop-blur-sm z-40 h-20">
        ...
        <motion.div
          ...
          className="text-dark-blue text-2xl sm:text-3xl font-black font-cinzel"
        >
          DDl
        </motion.div>
      ...
      >
        ...
        >
          <div className="bg-white/80 p-2 md:p-3">
            ...
            <div className="relative mb-4">
              ...
              <button
                ...
                className="w-52 flex items-center justify-between px-4 py-2 border border-dark-blue/20 rounded-lg bg-white hover:bg-lemon/10 transition-colors"
              >
              ...
              {/* Dropdown Menu */}
              {datasetsOpen && (
                <div className="absolute z-50 w-52 mt-1 bg-white border border-dark-blue/20 rounded-lg shadow-xl max-h-60 overflow-y-auto">
                  <div className="p-3 space-y-2">
                    {availableDatasets.map((ds) => (
                      <label
                        key={ds}
                        className="flex items-center gap-3 p-2 hover:bg-lemon/10 rounded-lg cursor-pointer"
                      >
                        <input
                          type="checkbox"
                          value={ds}
            ...
            {/* Two‑column layout with 25% / 75% split */}
            <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-3">
              <div className="space-y-6">
                {/* Budget Calculator */}
                <div className="border border-dark-blue/20 rounded-xl overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
              {/* Hispanic */}
              <div className="p-4 border border-dark-blue/10 rounded-lg">
